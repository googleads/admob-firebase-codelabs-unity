...
namespace AwesomeDrawingQuiz.Events {
    ...
    public class LevelSkipEventArgs : EventArgs {
        ...
        public static LevelSkipEventArgs Create(
            int attemps, int elapsedTime, bool isHintUsed, Drawing drawing) {
            LevelSkipEventArgs args = new LevelSkipEventArgs();
            args.NumAttempts = attemps;
